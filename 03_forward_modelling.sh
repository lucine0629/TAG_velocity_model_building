#!/bin/bash
## Script: 03_forward_modelling.sh
## Purpose: Run forward modelling for ray tracing using the inverted velocity model and plot the velocity model
## Author: S.Y. Lai
...
####################################
## DEFINE FORWARD tomo2d variables
####################################
N=4/4/4/8/1e-2/1e-3
ray=ray"$1".dat
src=src.dat
...
####################################################
## Forward ray tracing and make the velocity grid
####################################################
